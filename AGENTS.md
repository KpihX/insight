...
- **Folder:** `Hi-Paris_IPAI_Hackathlon` (ID: `[REDACTED]`)
- **Local GVFS mount:** `[REDACTED: mount via local file manager, never commit the path]`
- **Contents:**
...
```bash
DEST="[REDACTED]/insight_json_pipeline_stages"
# fixtures
...
- **Academic Background:**
    - **École Polytechnique (l'X)**, Palaiseau (Class X24, Graduation 2028). Specialization: Applied Mathematics & Computer Science.
        ...
        - **Hiérarchie DFHM:** `[REDACTED: internal directory, never commit]`
