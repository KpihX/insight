...
export default function SchedulePatchDialog() {
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center bg-[rgba(20,17,10,0.18)] backdrop-blur-[2px] px-4">
      <div className="w-full max-w-[560px] rounded-[24px] border border-[rgba(0,0,0,0.08)] bg-surface shadow-[0_24px_80px_rgba(0,0,0,0.16)] overflow-hidden">
        <div className="px-6 py-5 border-b border-border-light bg-[linear-gradient(135deg,rgba(250,238,218,0.95),rgba(255,255,255,0.95))]">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <h2 className="font-display text-[27px] leading-[1.1] text-text-main mt-1">A new meeting can be added to the timetable.</h2>
        ...
        <div className="px-6 py-4 border-t border-border-light flex items-center justify-between bg-surface2">
          <button
            onClick={dismissSuggestion}
            className="px-4 py-2.5 rounded-xl text-[13px] font-semibold text-text-2 hover:text-text-main transition-colors"
          >
            Dismiss for now
          </button>
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-4 py-2.5 rounded-xl text-[13px] font-semibold text-white bg-[#E7A21A] hover:bg-[#d19318] transition-colors"
            >
