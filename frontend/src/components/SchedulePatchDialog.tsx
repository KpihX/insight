...
export default function SchedulePatchDialog() {
  ...
  return (
  <div className="fixed inset-0 z-[120] flex items-center justify-center bg-[rgba(20,17,10,0.18)] backdrop-blur-[2px] px-4 py-6">
    ...
    <div className="w-full max-w-[560px] max-h-full flex flex-col rounded-[24px] border border-[rgba(0,0,0,0.08)] bg-surface shadow-[0_24px_80px_rgba(0,0,0,0.16)] overflow-hidden">
      ...
      <div className="px-6 py-5 border-b border-border-light bg-[linear-gradient(135deg,rgba(250,238,218,0.95),rgba(255,255,255,0.95))] shrink-0">
      ...
      <div className="px-6 py-5 grid gap-5 overflow-y-auto">
      ...
      <div className="px-6 py-4 border-t border-border-light flex items-center justify-between bg-surface2 shrink-0">
        <button
