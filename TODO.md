...
- [ ] Re-run `npm install`, `npm run lint`, and `npm run build` on a machine with full npm registry access and commit the refreshed lockfile.
...
- [ ] Tighten the frontend demo flow so inbox actions and timetable overlays feel fully synchronized.
